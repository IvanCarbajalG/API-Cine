...
import com.ivancarbajal.service_cine.model.Usuario;
    ...
    public class UsuarioService {
        ...
        //Al ser un campo final, Lombok generará un constructor que lo inicialice, y Spring lo inyectará automáticamente
        ...
        public void registrarUsuario(UsuarioRegistroDTO dto) {
            ...
            usuario.setRol("USER"); //Asignamos un rol por defecto, en este caso "USER"
